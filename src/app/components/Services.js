      ...
      <div className="max-w-screen-xl mx-auto text-center">
        ...
        <div className="mt-12 grid gap-8 grid-cols-1 md:grid-cols-2 lg:grid-cols-3">
          ...
          <div className="bg-white dark:bg-gray-800 rounded-lg overflow-hidden shadow-md">
            <img src="https://res.cloudinary.com/vistaprint/image/upload/c_scale,w_448,h_278,dpr_2/f_auto,q_auto/v1706101108/ideas-and-advice-prod/en-us/2ac977f5-bff9-4ef0-aa92-38931ae8fe60-2-e1500740591149.png?_i=AA" alt="Graphic Design" width={400} height={300} className="" layout="responsive" />
          ...
          <div className="bg-white dark:bg-gray-800 rounded-lg overflow-hidden shadow-md">
            <img src="https://volomagis.com/wp-content/uploads/2021/03/18695-scaled.jpg" alt="Branding" width={400} height={300} className="h-72" layout="responsive" />
