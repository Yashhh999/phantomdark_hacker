...
export default function Home() {
  ...
  return (
    <div className="bg-gray-50 dark:bg-gray-900 text-gray-800 dark:text-gray-200" >
      {/* Hero Section */}
      <section className="h-screen flex items-center justify-center bg-cover bg-center" style={{ backgroundImage: "url('https://cdn.discordapp.com/attachments/1242493595479441460/1246520938158100622/2fcd0099-3516-40a6-9938-bf7829158846.jpg?ex=665e0216&is=665cb096&hm=af073fb34d4526beac7b38d42474921214e03fe5d84cee18bf86536bafb6e15f&')" }}>
        <div className="container mx-auto flex flex-col-reverse md:flex-row items-center bg-black bg-opacity-50 p-6 md:p-12 rounded-lg">
          ...
          <div className="md:w-1/2 text-center">
            <img src="https://cdn.discordapp.com/attachments/1242493595479441460/1246523534788792340/dc.jpg?ex=665e0481&is=665cb301&hm=ad282e83e762e14bde1fe9a36196f4bd6da86d17e66d5022b37f5d943d3b5aa3&" alt="Phantom" width={400} height={400} className="rounded-full mx-auto" />
          </div>
        </div>
      </section>
